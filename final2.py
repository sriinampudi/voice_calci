...
Clear = Button(root, text="C", command = ClearPress, border=0, relief=SOLID,width=70,height=70,font='Calibri',fg='white',image=c,bg='white')
Clear.grid(row = 6, column = 1, padx=0, pady=2)
...
Back =Button(root, border=0,command=Back, relief=SOLID,width=180,height=70,fg='white',font='Calibri',image=back,bg='white')
Back.grid(row=7, column=1,columnspan=2,pady=(2,15))
